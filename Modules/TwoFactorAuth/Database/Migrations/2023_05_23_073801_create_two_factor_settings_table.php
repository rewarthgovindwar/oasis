...
class CreateTwoFactorSettingsTable extends Migration
{
    ...
    {
        Schema::create('two_factor_settings', function (Blueprint $blueprint): void {
            $blueprint->id();
            $blueprint->boolean('via_sms')->default(0);
            $blueprint->boolean('via_email')->default(1);
            $blueprint->tinyInteger('for_student')->default(2);
            $blueprint->tinyInteger('for_parent')->default(3);
            $blueprint->tinyInteger('for_teacher')->default(4);
            $blueprint->tinyInteger('for_staff')->default(6);
            $blueprint->tinyInteger('for_admin')->default(1);
            $blueprint->float('expired_time')->default(300);
        ...
        Schema::table('sm_general_settings', function (Blueprint $blueprint): void {
            if (! Schema::hasColumn('sm_general_settings', 'two_factor')) {
                $blueprint->boolean('two_factor')->nullable()->default(0);
            }
        });
