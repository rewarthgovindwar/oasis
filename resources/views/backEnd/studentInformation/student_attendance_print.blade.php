...
<body style="font-family: 'dejavu sans', sans-serif;" onload="window.print()">
        ...
        <tr>
            ...
            <td style="text-aligh:center"> 
               ...
               @else
                ...
                @if(shiftEnable())
                <p style="font-size:14px !important; border-bottom:1px solid gray" align="left" class="text-white">{{__('common.shift')}}: {{ $shift->name}} </p>
                @endif
                @endif
