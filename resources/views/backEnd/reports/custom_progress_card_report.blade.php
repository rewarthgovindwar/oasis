    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                @endif
                <div class="white-box">
                    {{ html()->form('POST',route('custom-progress-card-search'))->attributes([
            ...
            <div class="row">
                ...
                <div class="col-lg-8 pull-right mt-0">
                    <div class="print_button pull-right">
                        {{ html()->form('POST',route('custom-progress-card-print'))->attributes([
                            'class' => 'form-horizontal',
                            'files' => true,
                            'enctype' => 'multipart/form-data',
                            'id' => 'search_student',
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-lg-6 ml-30">
                                                    ...
                                                    <p class="text-white mb-0">
                                                        @lang('common.email'): {{isset($email)?$email:'hello@aorasoft.com'}} ,
                                                        @lang('common.phone'): {{isset(generalSetting()->phone)?generalSetting()->phone:'hello@aorasoft.com'}} 
                                                    </p>
                                                </div>
