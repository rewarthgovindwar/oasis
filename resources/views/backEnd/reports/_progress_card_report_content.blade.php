                        ...
                        <div class="col-lg-12 no-gutters">
                            <div class="main-title d-flex ">
                                ...
                                <div class="print_button pull-right">
                                    {{ html()->form('POST', route('progress-card/print'))->attributes([
                                            ...
                                            <div class="row">
                                                <div class="col-lg-7 text-black">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            ...
                                                            @if(shiftEnable())
                                                            <p class="mb-0">
                                                                @lang('common.shift') : <span class="primary-color fw-500">{{ $studentDetails->shift->name }}</span>
                                                            </p>
                                                            @endif
                                                            <p class="mb-0">
                                                        ...
                                                        <tr class="text-center">
                                                            ...
                                                            @if (@generalSetting()->result_type != 'mark')
                                                                ...
                                                                <td>{{number_format($final_results->total_gpa_point,2,'.','')}}
                                                                    ...
                                                                    @php
                                                                        if($final_results->total_gpa_point == 0){
                                                                            $has_failed  = true;    
                                                                        }                                                                   
                                                                    @endphp
                                                                </td>
                                                ...
                                                <table style="max-width: 400px; margin-bottom: 20px;" class="table border_table gray_header_table mb_30 max-width-400 ml-auto mr-auto report_table  @if(resultPrintStatus('vertical_boarder')) mt-5 @endif">
                                                    ...
                                                    @if (@generalSetting()->result_type != 'mark')
                                                        ...
                                                        {{-- Total Gpa Start --}}
                                                        <tr>
                                                            <td colspan="{{$colspan / $col_for_result - 1}}" >@lang('exam.total_grade') ss</td>
                                                            @if($has_failed)
