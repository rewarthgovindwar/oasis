    ...
    <div class="invoice_wrapper">
        ...
        <div class="{{(resultPrintStatus('body'))? "meritTableBody": "meritTableBodyCustomReport"}}">
                        ...
                        <table class="mb_30 mr_auto" style="width: 100%;">
                            ...
                            <tr>
                                <td>
                                    <p class="line_grid">
                                                <span>
                                                    <span>@lang('common.shift')</span>
                                                    <span>:</span>
                                                </span>
                                        {{ $student_detail->shift->name }}
                                    </p>
                                </td>
                            </tr>
                            @endif
            ...
            <div class="student_name_highlight" style="text-align: center; margin-bottom: 20px;">
             ...
             <table class="main-table table mb-0 center-table">
                                                        <thead>
                                                                    ...
                                                                    @php
                                                                        if($final_results != ""){
                                                                            if(@generalSetting()->result_type == 'mark'){
                                                                                ...
                                                                                echo number_format($totalMark, 2);
                                                    ...
                                                    <table style="max-width: 400px; margin: 30px auto;" class="table border_table gray_header_table mb_30 max-width-400 ml-auto mr-auto report_table ;  @if(resultPrintStatus('vertical_boarder')) mt-5 @endif">
                                                        <tbody>
                                                        {{-- Total Marks Start --}}
                                                        <tr>
