...
<body onLoad="loadHandler();">
    <div class="invoice_wrapper fullwidth_90">
                            ...
                            <div class="logo_img">
                                <div class="logo_thumb_upper">
                                    ...
                                    <h2>
                                        ...
                                        @else
                                        <p class="text-white">@if(shiftEnable()) @lang('admin.class_Sec_shift') @else @lang('admin.class_Sec') @endif : {{@$classInfo->class_name}} ({{@$sectionInfo->section_name}}) @if(shiftEnable()) [{{@$shiftInfo->name}}] @endif</p>
                                        @endif 
                                    </h2>
                                </div>
        ...
        <table class="table border_table gray_header_table mb-0" >
            <thead>
                <tr>
                    <th class="name_field" style="text-align: left">@lang('common.student_name')</th>
            ...
            <tbody>
                @foreach($mark_sheet as $data)
                    ...
                    @endphp
                    <tr>
                        <td style="text-align: left">{{$data->studentRecords->student->full_name}}</td>
