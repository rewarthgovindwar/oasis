...
@section('mainContent')
    ...
    <section class="admin-visitor-area">
        <div class="row">
            <div class="col-lg-12">
                <div class="white-box">
                    {{-- {{ html()->form('GET', route('percent-marksheet-report'))->class('form-horizontal')->open() }} --}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-5 pull-right">
                            <div class="print_button pull-right mb-30 mt-30">
                                {{ html()->form('POST', route('percent-marksheet-print'))->attributes([
                                ...
                                <input type="hidden" name="shift" value="{{@$shiftInfo->id}}">
                                ...
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            @if(shiftEnable())<h3 class="text-white">@lang('common.shift') : {{$shiftInfo->name}}</h3>@endif
                                        </div>
                                            ...
                                            <div class="student_marks_table pt-0">
                                                <div class="table-responsive">
                                                    <table class="mt-30 mb-20 table table-bordered w-100 scrolled_table">
                                                        <thead>
                                                            <tr>
                                                                <th class="name_field text-left">@lang('common.student_name')</th>
                                                            ...
                                                            @foreach ($mark_sheet as $data)
                                                                @php
                                                                    $totalMark = subjectPercentageMark(
                                                                        @$data->total_marks,
                                                                        @subjectFullMark($data->exam_type_id, $data->subject->id, $data->class_id, $data->section_id, shiftEnable() ? $data->studentRecords->shift_id : null),
                                                                    );

                                                                    $evaluation = markGpa($totalMark);
                                                                @endphp
                                                                @if(!empty($data->studentRecords) && !empty($data->studentRecords->student))
                                                                <tr>
                                                                    <td class="text-left">{{ $data->studentRecords->student->full_name }}
                                                                    </td>
