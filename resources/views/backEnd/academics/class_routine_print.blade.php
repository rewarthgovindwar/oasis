            ...
            <tr>
                ...
                <td style="text-aligh:left">
                    ...
                    <span style="font-size:11px !important;margin-right:10px;"
                        class="text-white"> @if(shiftEnable()) @lang('admin.class_Sec_shift') @else @lang('common.class_Sec') @endif:
                        @if($section)
                            {{ @$class->class_name . '(' . $section->section_name . ')' . (shiftEnable() ? ' [' . $shift->name . ']' : '') }}
                        @else
                            {{ @$class->class_name }}
                        @endif
                    </span>
